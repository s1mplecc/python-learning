...
在_Python 3_中，这不再是必需的，因为[https://docs.python.org/3/reference/datamodel.html\#object.ne\[documentation\]指出：](https://docs.python.org/3/reference/datamodel.html#object.ne[documentation]指出：)

 _默认情况下，ne （）委托给eq （）并反转结果，除非结果为NotImplemented。 比较运算符之间没有其他隐含关系，例如，（x的真值并不意味着x ⇐ y。_ 
